package com.westars.framework.util.log;
...
import com.westars.framework.BuildConfig;
...
public class Logs {
	...
	private static final String TAG = "xxz_logger";
	private static final String TAG_CLIENT = "wxxclient";
