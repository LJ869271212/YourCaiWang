package com.westars.framework.util.string;
...
public class Strings {
	...
	public static String findString(String search, String start, String end) {
		...
		int start_pos = Strings.isEmpty(start) ? 0 : search.indexOf(start);
		if (start_pos > -1) {
			int end_pos = Strings.isEmpty(end) ? -1 : search.indexOf(end, start_pos + start_len);
			if (end_pos > -1)
