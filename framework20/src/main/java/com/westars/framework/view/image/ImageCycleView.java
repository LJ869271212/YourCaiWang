...
import com.westars.framework.view.image.imagecycleview.ClickableImageView;
...
public class ImageCycleView extends LinearLayout {
	...
	private void init(Context context) {
		mContext = context;
		LayoutInflater.from(context).inflate(R.layout.com_westars_framework_view_image_imagecycleview, this);
	 ...
	 */
	public void setImageResources(ArrayList<String> imageDesList, ArrayList<String> imageUrlList,
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				mImageViews[i].setBackgroundResource(R.drawable.dos_ons);
			} else {
				mImageViews[i].setBackgroundResource(R.drawable.dos_offs);
			}
			mGroup.addView(mImageViews[i]);
		}

		imageName.setText(imageDesList.get(0));
		imageName.setTextColor(Color.parseColor("#ffffffff"));
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			// 设置图片滚动指示器背
			mImageViews[index].setBackgroundResource(R.drawable.dos_ons);
