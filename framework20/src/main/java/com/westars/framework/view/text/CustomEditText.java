...
public class CustomEditText extends CoreEditText {
	private interface SizeTester {
		 ...
		 * @return an integer < 0 if after applying {@code suggestedSize} to text, it takes less space than {@code availableSpace}, > 0
		 *         otherwise
		 */
