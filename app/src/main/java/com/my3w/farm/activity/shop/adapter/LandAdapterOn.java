...
public class LandAdapterOn extends BaseAdapter {

	private LayoutInflater mInflater;

	private ArrayList<SelectListLandOn> landList;

	public LandAdapterOn(Context context, ArrayList<SelectListLandOn> landList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		SelectListLandOn data = landList.get(position);
		if (data != null) {
