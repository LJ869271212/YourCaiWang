...
public class CircleAdapterNoScrollGridAdapter extends BaseAdapter {

	private ArrayList<CircleListImageListEntity> data;
	private LayoutInflater mInflater;

	public CircleAdapterNoScrollGridAdapter(Context context, ArrayList<CircleListImageListEntity> data) {
