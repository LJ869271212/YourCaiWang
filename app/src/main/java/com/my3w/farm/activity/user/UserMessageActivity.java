...
public class UserMessageActivity extends baseActivity {
	...
	private void initView() {
		...
		String user_nickString = DataCache.get(UserMessageActivity.this).getAsString("user_nick");
		...
		String user_picString = DataCache.get(UserMessageActivity.this).getAsString("user_pic");
	...
	private void initEvent() {
		...
		title_icon_box.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(UserMessageActivity.this, UserCenterActivity.class);
