 ...
 * 
 */
package com.my3w.farm.comment.tusdk.examples.api;
...
public class DefineCameraBaseFragment extends TuFragment {
	...
	private TuCameraFilterViewDelegate mFilterBarDelegate = new TuCameraFilterViewDelegate() {
		...
		@Override
		public void onGroupFilterShowStateWillChanged(TuCameraFilterView tuCameraFilterView, boolean b) {
