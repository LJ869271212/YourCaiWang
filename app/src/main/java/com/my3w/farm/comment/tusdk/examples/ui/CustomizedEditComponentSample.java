 ...
 * 
 */
package com.my3w.farm.comment.tusdk.examples.ui;
...
public class CustomizedEditComponentSample extends SampleBase implements TuEditTurnAndCutFragmentDelegate {
	 ...
	 * 示例代码：
	 * 
	 * TuEditTurnAndCutOption option = new TuEditTurnAndCutOption(); // 修改默认的Fragment类型
	 * option.setComponentClazz(ExtendEditTurnAndCutFragment.class); // 设置根视图布局资源ID
