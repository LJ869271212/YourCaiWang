 ...
 * @author Clear
 */
public class CameraComponentDynamic extends SampleBase implements TuCameraFragmentDelegate {
	...
	/** 相机组件范例 */
	public CameraComponentDynamic(Context context, onComponentListener listener) {
	...
	public void onTuCameraFragmentCaptured(TuCameraFragment fragment, TuSdkResult result) {
		...
		http.execute(context.getResources().getString(R.string.config_host_url) + "stretch.php?action=upload&&token="
