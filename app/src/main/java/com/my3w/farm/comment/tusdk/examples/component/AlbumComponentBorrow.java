 ...
 * @author Clear
 */
public class AlbumComponentBorrow extends SampleBase implements TuSdkComponentDelegate {
	...
	/** 相册组件范例 */
	public AlbumComponentBorrow(Context context, onComponentListener listener) {
		...
		public void handleMessage(Message msg) {
			if (msg.what == 200) {
				...
				try {
					...
					if (result == 0) {
						Log.e("AlbumComponentBorrow", jsonObject.toString());
