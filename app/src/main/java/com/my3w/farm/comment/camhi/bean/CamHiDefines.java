package com.my3w.farm.comment.camhi.bean;
...
public class CamHiDefines {
	...
	public static final int	 HI_P2P_ALARM_TOKEN_REGIST	 =	0x00004132	;/*��������ע�ᣬ�����״���������ʱ������*/
	public static final int	 HI_P2P_ALARM_TOKEN_UNREGIST =	0x00004133	;	/*��������ע��*/
	public static final int	HI_P2P_GET_OSD_PARAM  =	0x00003109;
	public static final int	HI_P2P_SET_OSD_PARAM  =	0x00003110;
	
	public static final int HI_P2P_ALARM_ADDRESS_GET =		0x0000415e	;	/*��ȡ������������ַ*/
	public static final int HI_P2P_ALARM_ADDRESS_SET =		0x0000415f	;	/*���ñ�����������ַ*/
