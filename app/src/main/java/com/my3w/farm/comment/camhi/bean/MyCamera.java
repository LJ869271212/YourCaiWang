...
import com.my3w.farm.comment.camhi.base.DatabaseManager;
import com.my3w.farm.comment.camhi.utils.SharePreUtils;
...
public class MyCamera extends HiCamera {
	...
	// int isFishEye=SharePreUtils.getInt("cache", mContext, this.getUid()+"isFishEye");
	// if(isFishEye!=1){//this.getmold() �豸�п��ܷ��ش������Ϣ this.getmold==1 ��������
