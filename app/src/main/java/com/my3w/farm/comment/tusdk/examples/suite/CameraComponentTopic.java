 ...
 * @author Clear
 */
public class CameraComponentTopic extends SampleBase implements TuCameraFragmentDelegate {
	...
	/** 相机组件范例 */
	public CameraComponentTopic(Context context, onComponentListener listener) {
