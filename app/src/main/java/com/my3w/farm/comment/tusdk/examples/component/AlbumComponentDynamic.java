 ...
 * @author Clear
 */
public class AlbumComponentDynamic extends SampleBase implements TuSdkComponentDelegate {
	...
	/** 相册组件范例 */
	public AlbumComponentDynamic(Context context, onComponentListener listener) {
